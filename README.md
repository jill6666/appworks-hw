...
# copy .env.example and paste your ALCHEMY_API_KEY
...
賞析 UniswapAnchoredView 合約並使用其作為 Comptroller 中設置的 oracle 來實現清算
設計一個能透過 flash loan 清算多種代幣類型的智能合約
研究 Aave 協議，比較這些借貸協議在功能上與合約開發上的差異
```
